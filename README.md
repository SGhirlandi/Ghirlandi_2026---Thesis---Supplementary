...
* **Conclusion**: Circular economy outcomes are not merely technical; they are deeply contingent on how political security priorities are operationalized.

## 📂 Repository Structure
* `/scripts`: Python code used for analysis.
* `/plots`: High-resolution versions of the figures used in the text.

The data and assumptions used in the thesis are avilabe in Zenodo: https://doi.org/10.5281/zenodo.18055825

## 🎓 Citation
If you use this work, please cite it as follows:
> Ghirlandi, Stefano. (2026). *Circular Economy as a Security Imperative: A Material and Economic Analysis of Titanium Supply in the EU*. Leiden University.
